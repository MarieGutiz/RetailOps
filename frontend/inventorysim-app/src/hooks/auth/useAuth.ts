...
// This hook manages all auth related logic such as registration, login, logout, and forgot password.
// It also defines the validation schemas for the registration, login etc using zod.
