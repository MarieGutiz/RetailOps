import { useGitHubStars } from "@/hooks/auth/useGitHubStars";
import { Star } from "lucide-react";
import  { motion } from "framer-motion"

const GitHubCTA = () => {
 const repoUrl="https://github.com/MarieGutiz/RetailOps";
 const stars = useGitHubStars();
  return (
    <div className="flex justify-center align-middle">
            {/* GitHub CTA */}
            <motion.a
                href="https://github.com/MarieGutiz/RetailOps"
                target="_blank"
                ...
                <span className="font-medium">Star this project on GitHub</span>
                <span className="text-xs text-muted-foreground">Open-source • MIT License</span>
                </div>


                <span className="ml-2 flex items-center gap-1 rounded-full border px-2 py-0.5 text-xs">
