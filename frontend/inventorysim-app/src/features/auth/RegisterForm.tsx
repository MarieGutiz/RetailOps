            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                {RegisterFormValidation.formState.errors.email && (
                  <FormError
                    message={
                      RegisterFormValidation.formState.errors.email.message ??
                      'Invalid email'
                    }
                  />
                )}
              ...
              {/* Confirm Password */}
              <div className="space-y-2">
                <Label htmlFor="confirm-password" className="block text-left">
                  Confirm Password
                </Label>
                <Input
                  id="confirm-password"
                ...
                {RegisterFormValidation.formState.errors.confirmPassword && (
                  <FormError
                    message={
                      RegisterFormValidation.formState.errors.confirmPassword.message?.toString() ??
