...
const LoginForm = () => {
  ...
  <div className="sm:mx-auto sm:w-full sm:max-w-sm">
    <img src="src/assets/range.jpg" alt="Your Company" className="mx-auto h-10 w-auto" />
  ...
  <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
    ...
    <p className="mt-10 text-center text-sm/6 text-gray-400">
      Not a member?
      <a href="#" className="font-semibold text-indigo-400 hover:text-indigo-300">Start now</a>
    </p>
  </div>
</div>
