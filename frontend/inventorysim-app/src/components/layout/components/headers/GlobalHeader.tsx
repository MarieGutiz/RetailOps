 ...
 * GlobalHeader
 *
 * Top-level header for the dashboard.
 *
 * Features:
 * - Displays current shop context for user-created shops.
 *   - Includes a delete button (Trash2 icon) for user shops.
 * - Shows default "Dashboard" title for autogenerated or no shop.
 * - Integrates `GlobalHeaderControls` on the right for sidebar management.
 *
 * 
 */
        ...
        {isUserShop && selectedSlice ? (
          <>
            ...
            <Trash2
              ...
              onClick={() =>
                selectedId &&
                handleDeleteUserShop(
                  selectedId,
                  selectedSlice.name ?? 'Unnamed shop'
                )
              }
            />
          </>
