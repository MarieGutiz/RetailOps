 ...
 * ModuleHeader
 *
 *  Reusable header section for modules, combining:
 * - Title and optional subtitle
 * - Optional breadcrumb trail
 * - Optional user case selector (controlled via `selectedUserCase`)
      ...
      <div className="w-full max-w-7xl mx-auto px-4">
        ...
        >
          ...
          <div className="flex flex-col items-center sm:items-start sm:basis-1/2">
            <h1 className="j-heading j-h1  sm: text-left text-xl whitespace-nowrap">
              {title}
            </h1>

            {subtitle && (
              <p className="j-heading j-subtitle text-base sm:text-left">
                {subtitle}
              </p>
            )}
          </div>
