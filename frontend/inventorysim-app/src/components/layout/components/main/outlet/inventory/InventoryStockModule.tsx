 ...
 * Provides a full inventory management and ABC analysis workflow:
 * - Displays product stock levels, values, and profitability
 * - Computes ABC classification and deltas vs baseline
 * - Renders Pareto curve and ABC summary visualizations
 * - Supports user-case selection, quantity updates, and product selection
 */
