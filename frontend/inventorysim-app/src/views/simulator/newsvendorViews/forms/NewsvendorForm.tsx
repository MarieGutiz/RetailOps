...
import {
  type NewsvendorFormValues,
  newsvendorSchema,
} from './props/newsvendor.schema';
          ...
          <div className="md:w-2/3 grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                step={1}
                type="number"
                {...register('meanDemand', { valueAsNumber: true })}
                disabled={!selectedProduct || disabled}
              />
              {errors.meanDemand && (
                <p className="text-xs text-destructive">
                  {errors.meanDemand.message}
                </p>
              )}
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                step={1}
                type="number"
                {...register('stdDeviation', { valueAsNumber: true })}
                disabled={!selectedProduct || disabled}
              />
              {errors.stdDeviation && (
                <p className="text-xs text-destructive">
                  {errors.stdDeviation.message}
                </p>
              )}
            </div>
            ...
            <div className="md:col-span-2 flex flex-col md:flex-row md:items-end gap-4">
              <div className="space-y-2 w-[200px]">
                ...
                <Input
                  id="simulationRuns"
                  type="number"
                  {...register('simulationRuns', { valueAsNumber: true })}
                  disabled={!selectedProduct || disabled}
                />
                {errors.simulationRuns && (
                  <p className="text-xs text-destructive">
                    {errors.simulationRuns.message}
                  </p>
                )}
              </div>
