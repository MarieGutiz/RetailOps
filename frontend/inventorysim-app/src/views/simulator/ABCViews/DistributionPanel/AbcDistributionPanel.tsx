...
> = {
  classic: {
    label: 'Classic ABC',
    description: 'Distribution based purely on total sales value ranking.',
    ...
    <div className="flex flex-col gap-6">
            ...
            return (
              <>
                ...
                <div className="pt-4 border-t text-sm sm:text-base text-muted-foreground leading-relaxed space-y-2">
                  <p>
                    Category A represents the critical minority driving
                    strategic importance. Category B captures moderate
                    contributors, while Category C forms the broad operational
                    base of lower-impact items.
                  </p>
      ...
      <Card>
        ...
        <CardContent className="flex flex-col h-80">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            The pie chart shows each category's contribution to total inventory
            value. Category A typically contains a few high-value items, B
            moderate contributors, and C many low-value items.
          </p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent className="flex flex-col h-80">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            The bar chart shows the number of items in each category. Category C
            usually contains the most items but contributes the least to total
            value.
          </p>
        </CardContent>
      </Card>
