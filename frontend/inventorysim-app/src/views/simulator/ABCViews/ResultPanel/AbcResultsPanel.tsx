...
const AbcResultsPanel = ({ response, isRunning, mode = 'classic' }: Props) => {
  ...
  const [hoverTableCategory, setHoverTableCategory] =
    useState<ABCCategory | null>(null);
  const [hoverThreshold, setHoverThreshold] = useState<'80' | '95' | null>(
    null
  );
    ...
    <div className="flex flex-col gap-8 w-full">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5">
        ...
        {(['A', 'B', 'C'] as ABCCategory[]).map((cat) => {
          ...
          const isHighlighted =
            hoverCategory === cat || hoverTableCategory === cat;
          ...
          <div className="flex flex-wrap gap-4 text-sm">
            {[
              ...
              return (
                ...
                >
                  <div className={`w-6 h-3 rounded-sm border ${th.color}`} />
