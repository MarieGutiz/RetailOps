                  ...
                  <TableBody>
                    {filteredProducts.map((prod) => {
                      const checked = !!fields.find(
                        (f) => f.product.id === prod.product.id
                      );
                      return (
                        <TableRow
                          key={prod.product.id}
          ...
          <div className="md:w-2/3 grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Select
                value={watch('mode')}
                onValueChange={(value) =>
                  setValue('mode', value as SimulationType, {
                    shouldValidate: true,
                  })
                }
                ...
                <Table>
                  ...
                  <TableBody>
                    {fields.map((field, idx) => {
                      ...
                      // Watch quantity sold
                      const quantitySold =
                        watch(`items.${idx}.salesValue`) || 0;
                      const calculatedSalesValue =
                        quantitySold * prod.product.unitPrice;
                        ...
                        <TableRow key={field.id}>
                          ...
                          <TableCell>
                            <Input
                              ...
                              className="h-8"
                              {...register(
                                `items.${idx}.demandFrequency` as const,
                                {
                                  valueAsNumber: true,
                                }
                              )}
