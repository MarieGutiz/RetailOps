    ...
    >
      ...
      >
        ...
        <AlertDescription className="text-[0.70rem] sm:text-xs md:text-sm lg:text-sm">
          You need to create a shop before running simulations or viewing
          inventory.
          <br />
          <br />
          You can either:
          <ul className="list-disc list-inside mt-1 text-left ml-4">
            <li>
              Go to <strong>Dashboard Overview</strong> and use the{' '}
              <strong>Create Shop</strong> button.
            </li>
            <li>
              Go to <strong>Inventory → Product Library</strong> to create a
              shop and start adding products.
            </li>
          </ul>
          <br />
          <Button
