...
export const buildAbcReport = (
  ...
  const kpis: ReportKPI[] = [
    ...
    },
    {
      ...
      hint: `${summary.a.valuePct.toFixed(1)}% of total value`,
    },
    {
      label: 'B Items Count',
      value: summary.b.count,
      hint: `${summary.b.valuePct.toFixed(1)}% of total value`,
    },
    {
      label: 'C Items Count',
      value: summary.c.count,
      hint: `${summary.c.valuePct.toFixed(1)}% of total value`,
    },
  ];
